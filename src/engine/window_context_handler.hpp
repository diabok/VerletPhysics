...
public:
    ...
    void registerCallbacks(sfev::EventManager& event_manager)
    {
        ...
        event_manager.addMouseRelesedCallback(sf::Mouse::Left, [&](sfev::CstEv) {
...
public:
    WindowContextHandler(const std::string& window_name,
                         ...
                         int32_t window_stype = sf::Style::Default)
        : m_window(sf::VideoMode(window_size.x, window_size.y), window_name, window_stype)
    ...
    sfev::EventManager& geteEventManager()
    {
